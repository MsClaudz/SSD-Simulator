...
# We can figure out the number of logical blocks that can fit into an erase block (put this in SizeSSD instead?)
...
# What we need to do: 
    # Create lists of lists to simulate an SSD structure
        ...
        # Determine the amount of overprovisioned blocks that should be kept empty in each partition (about 11 blocks for above example) (put in SizeSSD instead?)
